<picture>
  ...
  <img src="./assets/banner-light.jpg" alt="Patrick Astarita — industrial design → biotech founder → factory builder → software engineer. Senior/staff software engineer, founding engineer, founder building Mantafarm. New York City." width="880">
</picture>
...
<picture>
  ...
  <img src="./assets/now-light.jpg" alt="Currently: Lanternade (founder & principal engineer), Mantafarm (founder), Solar Ash (private-client CTO)" width="880">
</picture>
...
<picture>
  ...
  <img src="./assets/ventures-light.jpg" alt="Ventures under Astarita Research: Factorita, Mantafarm, Lanternade, Araeus, Pneumatter" width="880">
</picture>

<picture>
  <source media="(prefers-color-scheme: dark)" srcset="./assets/stack-dark.jpg">
  <img src="./assets/stack-light.jpg" alt="TypeScript · React / Next.js · Tailwind · Postgres · Cloudflare · Vercel · Typst · design systems · OpenTelemetry" width="880">
</picture>

<sub><a href="https://patrickastarita.com">patrickastarita.com</a> · <a href="https://www.linkedin.com/in/patrickastarita">linkedin.com/in/patrickastarita</a></sub>
